...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, () -> Solution.isPalindrome("A man, a plan, a canal: Panama"), true, x -> ((Boolean)x) == true);
        runTest(2, () -> Solution.isPalindrome("OpenAI"), false, x -> ((Boolean)x) == false);
        runTest(3, () -> Solution.isPalindrome("."), true, x -> ((Boolean)x) == true); // EDGE CASE
