...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, () -> Solution.factorial(5), 120, x -> ((Integer)x) == 120);
        runTest(2, () -> Solution.factorial(7), 5040, x -> ((Integer)x) == 5040);
        runTest(3, () -> Solution.factorial(0), 1, x -> ((Integer)x) == 1); // EDGE CASE
