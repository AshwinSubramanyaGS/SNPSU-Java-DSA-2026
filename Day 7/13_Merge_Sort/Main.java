...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, () -> Solution.mergeSort(new int[]{5,2,3,1}), new int[]{1,2,3,5}, x -> Arrays.equals((int[]) x, new int[]{1,2,3,5}));
        runTest(2, () -> Solution.mergeSort(new int[]{9,-1,4,4,2}), new int[]{-1,2,4,4,9}, x -> Arrays.equals((int[]) x, new int[]{-1,2,4,4,9}));
        runTest(3, () -> Solution.mergeSort(new int[]{7}), new int[]{7}, x -> Arrays.equals((int[]) x, new int[]{7})); // EDGE CASE
