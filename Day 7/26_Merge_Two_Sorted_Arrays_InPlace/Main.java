...
public class Main {
    ...
    public static void main(String[] args) {
        int[] a1={1,2,3,0,0,0}; int[] b1={2,5,6}; runTest(1, () -> { Solution.merge(a1,3,b1,3); return a1; }, new int[]{1,2,2,3,5,6}, x -> sameIntArray(x, null));
        int[] a2={1,0}; int[] b2={2}; runTest(2, () -> { Solution.merge(a2,1,b2,1); return a2; }, new int[]{1,2}, x -> sameIntArray(x, null));
        int[] a3={0}; int[] b3={1}; runTest(3, () -> { Solution.merge(a3,0,b3,1); return a3; }, new int[]{1}, x -> sameIntArray(x, null)); // EDGE CASE
