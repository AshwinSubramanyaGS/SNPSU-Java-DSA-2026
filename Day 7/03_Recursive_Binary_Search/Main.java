...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, () -> Solution.binarySearch(new int[]{1,3,5,7,9}, 7), 3, x -> ((Integer)x) == 3);
        runTest(2, () -> Solution.binarySearch(new int[]{2,4,6,8,10}, 5), -1, x -> ((Integer)x) == -1);
        runTest(3, () -> Solution.binarySearch(new int[]{42}, 42), 0, x -> ((Integer)x) == 0); // EDGE CASE
