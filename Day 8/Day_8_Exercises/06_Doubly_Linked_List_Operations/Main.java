...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.DoublyList d=new Solution.DoublyList(); d.addLast(2); d.addFirst(1); d.addLast(3); test(1,()->d.toArray(),new int[]{1,2,3},x->ints(x,1,2,3));
        d.removeFirst(2); test(2,()->d.toArray(),new int[]{1,3},x->ints(x,1,3));
        Solution.DoublyList e=new Solution.DoublyList(); test(3,()->e.toArray(),new int[]{},x->ints(x)); // EDGE CASE
