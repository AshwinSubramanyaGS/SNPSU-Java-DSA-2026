...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.Node h=null; h=Solution.insertHead(h,2); h=Solution.insertHead(h,1); h=Solution.insertTail(h,3); final Solution.Node fh=h; test(1,()->Solution.toArray(fh),new int[]{1,2,3},x->ints(x,1,2,3));
        Solution.Node h2=null; h2=Solution.insertTail(h2,5); h2=Solution.insertTail(h2,5); h2=Solution.insertTail(h2,7); h2=Solution.deleteFirst(h2,5); final Solution.Node fh2=h2; test(2,()->Solution.toArray(fh2),new int[]{5,7},x->ints(x,5,7));
        Solution.Node h3=null; test(3,()->Solution.toArray(h3),new int[]{},x->ints(x)); // EDGE CASE
