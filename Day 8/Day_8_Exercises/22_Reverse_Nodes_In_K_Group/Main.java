...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.Node h=Solution.reverseKGroup(node(1,2,3,4,5,6),2); final Solution.Node fh=h; test(1,()->Solution.toArray(fh),new int[]{2,1,4,3,6,5},x->ints(x,2,1,4,3,6,5));
        Solution.Node h2=Solution.reverseKGroup(node(1,2,3,4,5),3); final Solution.Node fh2=h2; test(2,()->Solution.toArray(fh2),new int[]{3,2,1,4,5},x->ints(x,3,2,1,4,5));
        Solution.Node h3=Solution.reverseKGroup(node(1,2),1); test(3,()->Solution.toArray(h3),new int[]{1,2},x->ints(x,1,2)); // EDGE CASE
