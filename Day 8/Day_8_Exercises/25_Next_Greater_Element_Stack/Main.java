...
public class Main {
    ...
    public static void main(String[] args) {
        test(1,()->Solution.nextGreater(new int[]{2,1,2,4,3}),new int[]{4,2,4,-1,-1},x->ints(x,4,2,4,-1,-1));
        test(2,()->Solution.nextGreater(new int[]{1,2,3}),new int[]{2,3,-1},x->ints(x,2,3,-1));
        test(3,()->Solution.nextGreater(new int[]{}),new int[]{},x->ints(x)); // EDGE CASE
