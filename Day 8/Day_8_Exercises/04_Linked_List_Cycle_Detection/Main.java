...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.Node h=node(1,2,3,4); Solution.Node entry=h.next; h.next.next.next=entry; final Solution.Node fh=h; test(1,()->Solution.hasCycle(fh),true,x->Boolean.TRUE.equals(x));
        Solution.Node h2=node(1,2,3); final Solution.Node fh2=h2; test(2,()->Solution.hasCycle(fh2),false,x->Boolean.FALSE.equals(x));
        Solution.Node h3=null; test(3,()->Solution.hasCycle(h3),false,x->Boolean.FALSE.equals(x)); // EDGE CASE
