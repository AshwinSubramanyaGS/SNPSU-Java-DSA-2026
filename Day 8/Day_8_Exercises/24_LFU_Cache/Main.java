...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.LFUCache c=new Solution.LFUCache(2); c.put(1,10);c.put(2,20);c.get(1);c.put(3,30); test(1,()->c.get(2),-1,x->Objects.equals(x,-1)); test(2,()->c.get(1),10,x->Objects.equals(x,10));
        Solution.LFUCache e=new Solution.LFUCache(0); e.put(1,1); test(3,()->e.get(1),-1,x->Objects.equals(x,-1)); // EDGE CASE
