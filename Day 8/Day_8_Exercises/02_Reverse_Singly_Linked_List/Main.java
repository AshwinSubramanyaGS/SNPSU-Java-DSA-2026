...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.Node h=node(1,2,3,4); h=Solution.reverse(h); final Solution.Node fh=h; test(1,()->Solution.toArray(fh),new int[]{4,3,2,1},x->ints(x,4,3,2,1));
        Solution.Node h2=node(5,6); h2=Solution.reverse(h2); final Solution.Node fh2=h2; test(2,()->Solution.toArray(fh2),new int[]{6,5},x->ints(x,6,5));
        Solution.Node h3=null; h3=Solution.reverse(h3); final Solution.Node fh3=h3; test(3,()->Solution.toArray(fh3),new int[]{},x->ints(x)); // EDGE CASE
