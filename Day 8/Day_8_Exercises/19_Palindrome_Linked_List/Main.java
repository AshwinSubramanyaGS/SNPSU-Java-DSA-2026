...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.Node h1=node(1,2,2,1); test(1,()->Solution.isPalindrome(h1),true,x->Objects.equals(x,true));
        Solution.Node h2=node(1,2,3); test(2,()->Solution.isPalindrome(h2),false,x->Objects.equals(x,false));
        Solution.Node h3=null; test(3,()->Solution.isPalindrome(h3),true,x->Objects.equals(x,true)); // EDGE CASE
