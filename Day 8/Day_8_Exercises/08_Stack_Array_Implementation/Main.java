...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.IntStack s=new Solution.IntStack(3); s.push(10);s.push(20); test(1,()->s.peek(),20,x->Objects.equals(x,20)); test(2,()->s.pop(),20,x->Objects.equals(x,20));
        Solution.IntStack s2=new Solution.IntStack(1); s2.push(1); test(3,()->s2.push(2),false,x->Objects.equals(x,false)); // EDGE CASE
