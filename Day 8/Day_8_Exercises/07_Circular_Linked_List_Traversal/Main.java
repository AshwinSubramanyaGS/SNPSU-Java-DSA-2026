...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.Node h=null; h=Solution.insertTail(h,1); h=Solution.insertTail(h,2); h=Solution.insertTail(h,3); final Solution.Node fh=h; test(1,()->Solution.oneCycle(fh),new int[]{1,2,3},x->ints(x,1,2,3));
        Solution.Node h2=null; h2=Solution.insertTail(h2,7); final Solution.Node fh2=h2; test(2,()->Solution.oneCycle(fh2),new int[]{7},x->ints(x,7));
        Solution.Node h3=null; test(3,()->Solution.oneCycle(h3),new int[]{},x->ints(x)); // EDGE CASE
