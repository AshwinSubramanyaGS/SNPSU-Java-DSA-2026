...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.StackWithQueues s=new Solution.StackWithQueues(); s.push(1);s.push(2);s.push(3); test(1,()->s.pop(),3,x->Objects.equals(x,3)); test(2,()->s.top(),2,x->Objects.equals(x,2));
        Solution.StackWithQueues e=new Solution.StackWithQueues(); test(3,()->e.pop(),Integer.MIN_VALUE,x->Objects.equals(x,Integer.MIN_VALUE)); // EDGE CASE
