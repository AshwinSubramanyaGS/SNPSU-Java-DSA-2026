# Deque With Constant-Time Front and Back Operations

Implement a deque for integers supporting addFirst, addLast, removeFirst, removeLast, and peek operations. Use a circular array so operations remain O(1).
