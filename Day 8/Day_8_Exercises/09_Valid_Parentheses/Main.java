...
public class Main {
    ...
    public static void main(String[] args) {
        test(1,()->Solution.isValid("{[()]}"),true,x->Objects.equals(x,true));
        test(2,()->Solution.isValid("([)]"),false,x->Objects.equals(x,false));
        test(3,()->Solution.isValid(""),true,x->Objects.equals(x,true)); // EDGE CASE
