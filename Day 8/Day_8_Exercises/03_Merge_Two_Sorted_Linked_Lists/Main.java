...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.Node a=node(1,3,5), b=node(2,4,6); final Solution.Node fh=Solution.merge(a,b); test(1,()->Solution.toArray(fh),new int[]{1,2,3,4,5,6},x->ints(x,1,2,3,4,5,6));
        Solution.Node a2=node(1,1), b2=node(1,2); final Solution.Node fh2=Solution.merge(a2,b2); test(2,()->Solution.toArray(fh2),new int[]{1,1,1,2},x->ints(x,1,1,1,2));
        Solution.Node h3=Solution.merge(null,null); test(3,()->Solution.toArray(h3),new int[]{},x->ints(x)); // EDGE CASE
