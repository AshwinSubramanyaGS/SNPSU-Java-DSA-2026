...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.MinStack s=new Solution.MinStack(); s.push(3);s.push(1);s.push(2); test(1,()->s.getMin(),1,x->Objects.equals(x,1)); test(2,()->s.pop(),2,x->Objects.equals(x,2));
        Solution.MinStack e=new Solution.MinStack(); test(3,()->e.pop(),Integer.MIN_VALUE,x->Objects.equals(x,Integer.MIN_VALUE)); // EDGE CASE
