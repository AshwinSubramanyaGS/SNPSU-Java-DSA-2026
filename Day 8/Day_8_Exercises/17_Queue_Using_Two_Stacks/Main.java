...
public class Main {
    ...
    public static void main(String[] args) {
        Solution.QueueWithStacks q=new Solution.QueueWithStacks(); q.enqueue(1);q.enqueue(2);q.enqueue(3); test(1,()->q.dequeue(),1,x->Objects.equals(x,1)); test(2,()->q.peek(),2,x->Objects.equals(x,2));
        Solution.QueueWithStacks e=new Solution.QueueWithStacks(); test(3,()->e.dequeue(),Integer.MIN_VALUE,x->Objects.equals(x,Integer.MIN_VALUE)); // EDGE CASE
