...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, Solution.longestConsecutive(new int[]{100,4,200,1,3,2}), 4, () -> Objects.equals(Solution.longestConsecutive(new int[]{100,4,200,1,3,2}), 4));
        runTest(2, Solution.longestConsecutive(new int[]{9,1,4,7,3,2,6,8,10}), 5, () -> Objects.equals(Solution.longestConsecutive(new int[]{9,1,4,7,3,2,6,8,10}), 5));
        runTest(3, Solution.longestConsecutive(new int[]{}), 0, () -> Objects.equals(Solution.longestConsecutive(new int[]{}), 0));
