...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, Solution.firstUniqChar("leetcode"), 0, () -> Objects.equals(Solution.firstUniqChar("leetcode"), 0));
        runTest(2, Solution.firstUniqChar("aabb"), -1, () -> Objects.equals(Solution.firstUniqChar("aabb"), -1));
        runTest(3, Solution.firstUniqChar(""), -1, () -> Objects.equals(Solution.firstUniqChar(""), -1));
