...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, Solution.singleNumber(new int[]{2,2,1}), 1, () -> Objects.equals(Solution.singleNumber(new int[]{2,2,1}), 1));
        runTest(2, Solution.singleNumber(new int[]{4,1,2,1,2}), 4, () -> Objects.equals(Solution.singleNumber(new int[]{4,1,2,1,2}), 4));
        runTest(3, Solution.singleNumber(new int[]{7}), 7, () -> Objects.equals(Solution.singleNumber(new int[]{7}), 7));
