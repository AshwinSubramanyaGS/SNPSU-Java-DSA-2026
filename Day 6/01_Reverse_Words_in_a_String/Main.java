...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, Solution.reverseWords("hello world java"), "java world hello", () -> Objects.equals(Solution.reverseWords("hello world java"), "java world hello"));
        runTest(2, Solution.reverseWords("  I love coding  "), "coding love I", () -> Objects.equals(Solution.reverseWords("  I love coding  "), "coding love I"));
        runTest(3, Solution.reverseWords("   hello   "), "hello", () -> Objects.equals(Solution.reverseWords("   hello   "), "hello"));
