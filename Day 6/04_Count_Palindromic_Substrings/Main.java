...
public class Main {
    ...
    public static void main(String[] args) {
        runTest(1, Solution.countPalindromicSubstrings("aaa"), 6, () -> Objects.equals(Solution.countPalindromicSubstrings("aaa"), 6));
        runTest(2, Solution.countPalindromicSubstrings("abc"), 3, () -> Objects.equals(Solution.countPalindromicSubstrings("abc"), 3));
        runTest(3, Solution.countPalindromicSubstrings(""), 0, () -> Objects.equals(Solution.countPalindromicSubstrings(""), 0));
